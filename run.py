...
def has_something_to_open():
    r = requests.post('https://red.xunlei.com/index.php?r=mine/info',verify=False, headers=g_headers2, cookies=g_cookies)
    if r.status_code != 200:
...
## fetch crystal
def post_crystal():
     r = requests.post('https://red.xunlei.com/index.php?r=mine/collect',verify=False, headers=g_headers2, cookies=g_cookies)
     if r.status_code != 200:
